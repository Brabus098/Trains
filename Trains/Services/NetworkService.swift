...
actor NetworkService {
    ...
    func fetchNearestStations(for place: ChoosePlaceModel) async throws -> [ChooseStationModel] {
    ...
    private func convertStationsResponse(_ response: NearestStations) -> [ChooseStationModel] {
        var result: [ChooseStationModel] = []
    ...
    private func from(_ time: String) -> TimeOfDayType {
        let formatter = DateFormatter()
