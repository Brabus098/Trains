    ...
    var body: some View {
        NavigationStack(path: $navigationPath) {
            VStack {
                ...
                ChooseDirection(viewModel: viewModel, navigationPath: $navigationPath, activeDirection: $activeDirection)
            ...
            .navigationDestination(for: DirectionType.self) { direction in
                ZStack {
                    ...
                    VStack(spacing: 0) {
                        ...
                        ChooseCity(hideTabBar: $hideTabBar, navigationPath: $navigationPath,
                                   viewModel: viewModel,
                ...
                if route == "SelectStation" {
                    ZStack {
                        ...
                        VStack(spacing: 0) {
                            ...
                            .background(Color.background)
                            ChooseStation(hideTabBar: $hideTabBar, viewModel: viewModel, navigationPath: $navigationPath)
                                .navigationBarHidden(true)
                        }
                    }
                }
                    ...
                    if let from = viewModel.directionFrom, let to = viewModel.directionTo {
                        ZStack {
                            ...
                            VStack(spacing: 0) {
                                ...
                                .background(Color.background)
                                CompanyList(viewModel: companyViewModel, navigationPath: $navigationPath, directionTo: to, directionFrom: from)
                                    .navigationBarHidden(true)
                            }
                        }
                    }
