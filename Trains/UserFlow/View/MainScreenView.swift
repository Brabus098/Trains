...
struct MainScreenView: View {
    ...
    @State private var chooseDirectionViewModel: ChooseDirectionViewModel
    @State private var chooseCityViewModel: ChooseCityViewModel
    @State private var chooseStationViewModel: ChooseStationViewModel
    @State private var storiesLentViewModel: StoriesLentViewModel
    @State private var storiesFeedViewModel: StoriesFeedViewModel
    ...
    init(hideTabBar: Binding<Bool>, storiesService: StoriesService,
        ...
        self._chooseCityViewModel = State(
            initialValue: ChooseCityViewModel(directionService: directionService)
        )
        self._chooseStationViewModel = State(initialValue: ChooseStationViewModel(directionService: directionService))
        self._chooseDirectionViewModel = State(initialValue: ChooseDirectionViewModel(directionService: directionService))
