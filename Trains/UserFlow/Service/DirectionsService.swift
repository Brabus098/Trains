...
@Observable final class DirectionsService {
    ...
    private let stationsSubject = CurrentValueSubject<[ChooseStationModel], Never>([])
    ...
    var stationsPublisher: AnyPublisher<[ChooseStationModel], Never> {
    ...
    var selectedCity: ChoosePlaceModel?
    var selectedStation: ChooseStationModel?
